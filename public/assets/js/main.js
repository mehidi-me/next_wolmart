...
(function ($) {
  ...
  Wolmart.initPopup = function (options, preset) {
    ...
    if (
      ...
      Wolmart.getCookie("hideNewsletterPopup") !== "true"
    ) {
      setTimeout(function () {
        Wolmart.popup({
          items: {
...
(function ($) {
  ...
  var initProductQuickview = function () {
    ...
    //           Wolmart.productSingle($(".mfp-product-o .product-single"));
    //           // });
    //           // $popup.defaults.callbacks.open();
    //         },
    //         close: function () {
    //           $(".mfp-product-o .swiper-container").data("slider").destroy();
    //         },
    //       },
    //     },
    //     "quickview"
...
(function ($) {
  ...
  Popup.presets = {
    quickview: {
      type: "inline",
      mainClass: "mfp-product-o mfp-fade",
      tLoading: "Loading...",
    },
    video: {
      type: "iframe",
  ...
  Popup.prototype.init = function (options, preset) {
    ...
    function closePopupByBgClick(e) {
      if (
        !$(e.target).closest(".mfp-content-o").length ||
        $(e.target).hasClass("mfp-content-o")
      ) {
...
(function ($) {
  ...
  ProductSingle.prototype.init = function ($el) {
    ...
    // members
    self.$wrapper = $el;
    self.isQuickView = !!$el.closest(".mfp-content-o").length;
